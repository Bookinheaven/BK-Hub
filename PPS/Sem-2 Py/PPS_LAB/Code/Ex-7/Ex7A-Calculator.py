...
labl2.grid(row=5, column=0,padx=20,pady=5)

labl3 = Label(master=Frame1, text="Type Value 2:", font=("Arial",13))
labl3.grid(row=6, column=0,padx=20,pady=5)

labl2_var = StringVar()
entr1 = Entry(master=Frame1, textvariable=labl2_var)
entr1.grid(row=5, column=1,padx=10,pady=5)

labl3_var = StringVar()
entr2 = Entry(master=Frame1, textvariable=labl3_var)
entr2.grid(row=6, column=1,padx=10,pady=5)
Frame1.rowconfigure(7, weight=1)
Frame2 = Frame(master=Frame1)
Frame2.grid(row=7, column=1, sticky='nsew', padx=10, pady=10)
...
res.grid(row=8, column=0,padx=20,pady=5)

entr3 = Entry(master=Frame1)
entr3.grid(row=8, column=1,padx=10,pady=5)
